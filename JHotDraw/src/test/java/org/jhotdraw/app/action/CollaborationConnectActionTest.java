 ...
 * @author Niclas
 */
public class CollaborationConnectActionTest {
    ...
    public void menuEnabledTest() throws UnknownHostException {
        ...
        AbstractApplicationAction connectAction = new CollaborationConnectAction(app);
                        
        assertTrue(connectAction.isEnabled());
        app.connectToServer(InetAddress.getLocalHost().getHostAddress());
        assertFalse(connectAction.isEnabled());

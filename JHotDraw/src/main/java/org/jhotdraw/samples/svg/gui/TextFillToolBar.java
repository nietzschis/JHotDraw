...
/**
 * TextFillToolBar is a copy of FillToolBar repurpursed to edit the color of text
 */
 ...
 */
public class TextFillToolBar extends AbstractToolBar {

    private SelectionComponentDisplayer displayer;

    /** Creates new instance. */
    public TextFillToolBar() {
            ...
            case 1:
                 {
                    ...
                    btn = ButtonFactory.createSelectionColorButton(editor,
                            TEXT_COLOR, ButtonFactory.HSV_COLORS, ButtonFactory.HSV_COLORS_COLUMN_COUNT,
                    ...
                    opacityPopupButton.setIcon(
                            new SelectionOpacityIcon(editor, TEXT_OPACITY, TEXT_COLOR, null, getClass().getResource(labels.getString("attribute.fillOpacity.icon")),
                    ...
                    new FigureAttributeEditorHandler<Double>(TEXT_OPACITY, opacitySlider, editor);
                }
                break;
            ...
            case 2:
                 {
                    ...
                    new FigureAttributeEditorHandler<Color>(TEXT_COLOR, defaultAttributes, colorField, editor, true);
                    gbc = new GridBagConstraints();
                    gbc.gridx = 0;
                    ...
                    new FigureAttributeEditorHandler<Double>(TEXT_OPACITY, opacityField, editor);
                    gbc = new GridBagConstraints();
                    gbc.gridx = 0;
                    gbc.insets = new Insets(3, 0, 0, 0);
                    gbc.fill = GridBagConstraints.HORIZONTAL;

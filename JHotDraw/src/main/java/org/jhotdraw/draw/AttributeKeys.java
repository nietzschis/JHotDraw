...
public class AttributeKeys {
    ...
    public final static AttributeKey<Color> STROKE_COLOR_LEFT_MOUSE = new AttributeKey<Color>("strokeColorLeftMouse", Color.class, Color.green, true, labels);
    public final static AttributeKey<Color> STROKE_COLOR_RIGHT_MOUSE = new AttributeKey<Color>("strokeColorRightMouse", Color.class, Color.red, true, labels);
    /**

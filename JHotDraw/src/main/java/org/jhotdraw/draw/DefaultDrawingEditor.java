...
public class DefaultDrawingEditor extends AbstractBean implements DrawingEditor, ToolListener {
    ...
    public DefaultDrawingEditor() {
        ...
        setDefaultAttribute(FILL_COLOR_LEFT_MOUSE, Color.white);
        setDefaultAttribute(FILL_COLOR_RIGHT_MOUSE, Color.white);
        
        setDefaultAttribute(STROKE_COLOR, Color.black);
        setDefaultAttribute(STROKE_COLOR_LEFT_MOUSE, Color.black);
        setDefaultAttribute(STROKE_COLOR_RIGHT_MOUSE, Color.black);
